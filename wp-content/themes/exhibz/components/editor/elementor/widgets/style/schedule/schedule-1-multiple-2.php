            ...
            <div class="ts-schedule-info mb-70">
               <ul class="nav nav-tabs" role="tablist">
                  ...
                  ?>
                     <?php if ($i == 1) { ?>
                        <li class="nav-item">
                           <a class="active" title="<?php esc_attr_e('Click Me', 'exhibz'); ?>" href="<?php echo esc_attr("#exhibz-date" . $i); ?>" role="tab" data-toggle="tab">
                     ...
                     <?php } else { ?>
                        <li class="nav-item">
                           <a title="<?php esc_attr_e('Click Me', 'exhibz'); ?>" href="<?php echo esc_attr("#exhibz-date" . $i); ?>" role="tab" data-toggle="tab">
                              <h3><?php echo get_the_title($postnav->ID) ?></h3>
      ...
      <div class="row">
         <div class="col-lg-12">
            <div class="tab-content schedule-tabs">
               ...
               ?>
                  <?php if ($j == 1) { ?>
                     <div role="tabpanel" class="test2 tab-pane active" id="<?php echo esc_attr("date" . $j); ?>">
                                          ...
                                          <?php foreach ($multiple_speaker as $key => $value) { ?>
                                             <div class="speaker-content">
                                                ...
                                                <?php if (isset($value['attachment_id'])) : ?>
                                                   <a target="_blank" href="<?php echo esc_url(get_the_permalink($speaker_id[$key])); ?>">
