...
final class Bootstrap {
    ...
    public function handle_buy_pro_module(){
        ...
        */
        ...
        $filter_string .= ((!in_array('eventin-pro/eventin-pro.php', apply_filters('active_plugins', get_option('active_plugins')))) ? '' : ',eventin-pro');
        $filter_string .= (!class_exists('\Wpeventin_Pro') ? '' : ',eventin-pro');
    ...
    public function js_css_public() {
        ...
        wp_enqueue_script( 'etn-public', \Wpeventin::assets_url() . 'js/event-manager-public.js', ['jquery'], \Wpeventin::version(), true );
         ...
         wp_localize_script( 'etn-public', 'form_data', $form_data );
    }
    ...
    function register_admin_menu() {
        ...
        $settings = Core\Settings\Settings::instance()->init( $this->name(), \Wpeventin::version() );
    }
