jQuery(document).ready(function ($) {
    ...
    // $("input[name='etn_event_recurrence[span_type]']").on('change',function(){

        // var _this                               = $(this);
        // var selected_span_type                  = _this.val();
        // var multiple_span_count_holder          = $(".event-multiple-span-days-holder");
        // var multiple_span_count_input           = _this.parents(".etn-recurring-event-span").find("input[name='etn_event_recurrence[recurrence_span]']");
        // var multiple_span_count_selected_value  = multiple_span_count_input.val();
        // console.log(multiple_span_count_selected_value);
        // if ( selected_span_type == "single") {
        //     console.log('single haha');
            // multiple_span_count_input.val('1');
        //     multiple_span_count_input.prop("readonly", true);
        // } else if ( selected_span_type == "multiple") {
        //     console.log('multiple haha');
            // multiple_span_count_input.val(multiple_span_count_selected_value);
        //     multiple_span_count_input.prop("readonly", false);

        // }
        // console.log(multiple_span_count_selected_value);
    // });
    // $("input[name='etn_event_recurrence[span_type]']").trigger('change');
