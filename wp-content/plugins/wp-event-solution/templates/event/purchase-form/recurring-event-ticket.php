...
$active_item = ($key===0)? 'style=display:block' : '';
?>
        ...
        <div class="etn-col-lg-3">
                <div class="etn-left-datemeta">
                    <div class="etn-date-meta">
                        <?php echo date_i18n('M, y', strtotime( $data['event_start_date'] )) ; ?>
                        <?php echo esc_attr($separate); ?>
                        <?php echo date_i18n('M, y', strtotime( $data['event_end_date'] )); ?>
                        <span>
                            <?php echo date_i18n('j', strtotime( $data['event_start_date'] )); ?>
                            <?php echo esc_attr($separate); ?>
                            <?php echo date_i18n('j', strtotime( $data['event_end_date'] )); ?>
                        </span>
                    </div>
                    <?php
